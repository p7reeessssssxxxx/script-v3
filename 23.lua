...
-- 🟣 Page fallback for universal click / tap
task.spawn(function()
...
-- 🟣 SubPage fallback for universal click / tap
task.spawn(function()
    while not (Items and Items["Inactive"] and Items["Inactive"].Instance) do
        task.wait()
    end
...
Components.Label = function(self, Data)
    ...
    Items["Text"] = Instances:Create("TextLabel", {
        ...
        RichText = true, -- ✅ color tags like <font color='rgb(255, 215, 0)'>
        TextWrapped = true,
        TextSize = 12,
        AutomaticSize = Enum.AutomaticSize.XY, -- ✅ auto width + height
    ...
    -- 📦 Sub-elements container (optional extras)
    Items["SubElements"] = Instances:Create("Frame", {
        Parent = Items["Label"].Instance,
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
...
BorderSizePixel = 0,
AutoButtonColor = false,
Image = "rbxassetid://82562784336028",
